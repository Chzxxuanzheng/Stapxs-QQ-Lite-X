import{r as a,S as f}from"./main-D9TYCSu5.js";import{n as y}from"./@vue-BZudgvaU.js";let c=!1,r="";function x(){c||(c=!0,y(()=>{c=!1;let e=0;if(a.sysConfig.use_favicon_notice===!1)return s(0);for(const l of f.activeSessions.values())l.newMsg>0&&e++;s(e)}))}function s(e){const l=e.toString().length*150,i=getComputedStyle(document.documentElement).getPropertyValue("--color-main").trim();if(r===`${e}-${i}`)return;r=`${e}-${i}`;const o=`
